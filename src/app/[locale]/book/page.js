...
export default async function BookingPage({ params }) {
  ...
  const labels = {
    ...
    guests: t("guests"),
    sharedToggle: t("sharedToggle"),
    sharedCapacityUnavailable: t("sharedCapacityUnavailable"),
    sharedOpenSeats: t("sharedOpenSeats"),
    sharedGenderPreference: t("sharedGenderPreference"),
    sharedGenderPreferenceHelper: t("sharedGenderPreferenceHelper"),
    sharedInfoButton: t("sharedInfoButton"),
    sharedInfoTitle: t("sharedInfoTitle"),
    sharedInfoBodyOne: t("sharedInfoBodyOne"),
    sharedInfoBodyTwo: t("sharedInfoBodyTwo"),
    sharedInfoBodyThree: t("sharedInfoBodyThree"),
    sharedInfoImportantTitle: t("sharedInfoImportantTitle"),
    sharedInfoImportantOne: t("sharedInfoImportantOne"),
    sharedInfoImportantTwo: t("sharedInfoImportantTwo"),
    sharedInfoImportantThree: t("sharedInfoImportantThree"),
    sharedInfoClose: t("sharedInfoClose"),
    sharedBrowseButton: t("sharedBrowseButton"),
    sharedGenderPreferenceOptions: [
      { value: "any", label: t("sharedGenderAny") },
      { value: "female_only", label: t("sharedGenderFemaleOnly") },
      { value: "male_only", label: t("sharedGenderMaleOnly") },
    ],
    tourType: t("tourType"),
    ...
    reducedPrice: t("reducedPrice"),
    totalPrice: t("totalPrice"),
    reserveToday: t("reserveToday"),
    payOnBoard: t("payOnBoard"),
    originalReservationFee: t("originalReservationFee"),
    ...
    bookingCutoffError: t("bookingCutoffError"),
