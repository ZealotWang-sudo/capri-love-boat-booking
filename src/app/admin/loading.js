        ...
        <div className="border border-stone-300 bg-[#fbf8f3] p-6">
          <div className="flex items-center justify-between gap-4">
            <div className="w-full max-w-md">
              <div className="h-3 w-32 animate-pulse bg-stone-300" />
              <div className="mt-3 h-9 w-56 animate-pulse bg-stone-300" />
              <div className="mt-4 h-3 w-40 animate-pulse bg-stone-300" />
            </div>
