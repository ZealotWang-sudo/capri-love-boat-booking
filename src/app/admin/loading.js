        ...
        <div className="border border-stone-300 bg-[#fbf8f3] p-4 sm:p-6">
          <div className="flex min-w-0 flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="min-w-0 w-full max-w-md">
              <div className="h-3 w-32 max-w-full animate-pulse bg-stone-300" />
              <div className="mt-3 h-9 w-56 max-w-full animate-pulse bg-stone-300" />
              <div className="mt-4 h-3 w-40 max-w-full animate-pulse bg-stone-300" />
            </div>
