...
export default function StyledCheckbox({
  ...
  return (
    <label className="group block cursor-pointer">
      ...
      />
      <span className="flex min-h-16 items-center gap-4 border border-stone-300 bg-transparent px-4 py-3 text-sm leading-6 transition peer-checked:border-stone-950 peer-checked:bg-stone-950 peer-checked:text-[#f3eee7] peer-checked:[&_.check-box]:bg-[#f3eee7] peer-checked:[&_.check-mark]:opacity-100 peer-focus-visible:outline peer-focus-visible:outline-2 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-stone-950 group-hover:border-stone-950">
